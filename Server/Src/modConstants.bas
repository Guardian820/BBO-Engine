...
Public Const Total_BonusItems As Byte = 4
...
' General constants
Public Const GAME_NAME As String = "Bomberman Online"
...
' Website
Public Const GAME_WEBSITE As String = "http://www.asphodelgames.com"
...
Public Const SayColor As Byte = DarkGrey
